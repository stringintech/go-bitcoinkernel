...
// SetWipeDBs sets the wipe database options
...
// SetBlockTreeDBInMemory sets whether to keep block tree DB in memory
...
// SetChainstateDBInMemory sets whether to keep chainstate DB in memory
...
// destroy deallocates the chainstate manager options
...
// GetBlockIndexFromHeight returns the block index for a given height
...
// destroy deallocates the chainstate manager
